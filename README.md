...
2. ### Jenkins Setup
   This section explains how I set up and run Jenkins in a Docker container for continuous integration and deployment. Jenkins is accessible at `http://localhost:8080`. \
Here's how it works:
